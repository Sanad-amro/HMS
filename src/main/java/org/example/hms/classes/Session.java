...
public class Session {
    ...
    public Session(int sessionId, int patientId, double hgb, int weight, int bloodGlucose, int fastingBloodGlucose, int randomBloodGlucose, int heartRate, int diastolicBloodPressure, int systolicBloodPressure, String bloodPressure, String chiefComplaint, String medicalHistory, String medicalAndSurgicalHistory, String obstetricHistory, String gynecologicalHistory, String doctorAndMidwifeNote, String diagnosis, String currentMedications, String prescribedMedications, String nutritionistNote, String physiotherapistNote, String addedBy, int day, int month, int year, String address, String midWifeNote, String psychologistNote,String patientName, int quantity) {
    ...
    public static ArrayList<Session> getAllSessions() {
        ...
        try (Connection conn = getConnection(); PreparedStatement stmt = conn.prepareStatement(query)) {
            ...
            while (rs.next()) {
                ...
                session.quantity=rs.getInt("quantity");
    ...
    public static boolean updateSessionById(Session session) {
        ...
        try (Connection conn = getConnection(); PreparedStatement stmt = conn.prepareStatement(query)) {
            ...
            stmt.setDouble(2, session.getHgb());
