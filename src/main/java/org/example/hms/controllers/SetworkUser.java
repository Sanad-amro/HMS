...
public class SetworkUser {
    ...
    public void set(ActionEvent event) throws IOException {
        ...
        if(!saveForEachDay.isSelected()){
            ...
            User.setWorkTime(User.getId(),saturdayBox.isSelected()? alldays:noWork,sundayBox.isSelected()? alldays:noWork,mondayBox.isSelected()? alldays:noWork,tuesdayBox.isSelected()? alldays:noWork,wednesdayBox.isSelected()? alldays:noWork,thursdayBox.isSelected()? alldays:noWork,fridayBox.isSelected()? alldays:noWork);
            ...
            User.setWorkTime(User.getId(),saturday,sunday,monday,tuesday,wednesday,thursday,friday);
